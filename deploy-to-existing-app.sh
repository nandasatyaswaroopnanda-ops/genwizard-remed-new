...
echo -e "  • Identity Management: Synced groups (${BOLD}IM_SAML${NC}, ${BOLD}itsm_admin${NC}, ${BOLD}itsm_user${NC}, ${BOLD}itsm_read${NC}) with permissions"
...
echo -e "  • End-users logging in via SSO: Automatically assigned ${BOLD}IM_SAML${NC} group for ticketing access"
echo -e "\n==============================================================================\n"
